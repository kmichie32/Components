...
public class ListQueueTest {
    ...
    /**
     * Sets up A ListQueue before each
     * test.
    ...
    public void testAppend() {
        ...
        assertEquals(4, s3.length());
        assertEquals("A", s3.dequeue());
        assertEquals(3, s3.length());
    }
    ...
    /**
     * Tests creation of ListQueue parameters
     */
    @Test
    ...
    public void testEnqueueMethod() {
        Queue<String> q = new ListQueue<>(5);
        q.enqueue("hello");
        q.enqueue("world");
        String s = q.dequeue();
